...
final class CaptureMetadataTests: XCTestCase {
    ...
    func testMetadataWriterWritesJson() throws {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("cshotMetadataTests-\(UUID().uuidString)", isDirectory: true)
        ...
        let decoded = try JSONDecoder.cshot.decode(CaptureMetadata.self, from: data)
